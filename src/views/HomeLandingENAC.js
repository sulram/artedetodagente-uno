    ...
    <section id="enac" className="base enac">
      ...
      <div className="content">
        <div>
          ...
          <p>O <strong>ENAC</strong> é uma iniciativa do desenvolvido pelo Laboratório Arte, Cultura, Acessibilidade e Saúde - LACAS do Departamento de Terapia Ocupacional da Faculdade de Medicina da UFRJ.  O LACAS é parceiro do projeto Um Novo Olhar, da Escola de Música da UFRJ e FUNARTE.</p>
