export default {
  ...
  'repertorio-coral': {
    ...
    categories: [
      {
        id: 'edino-krieger-20-rondas-infantis',
        cover: '/img/static/rc-edino-krieger.jpg',
        title: '20 Rondas Infantis',
        text: `A coleção 20 Rondas Infantis, de Edino Krieger, está disponível para auxiliar professores em arte-educação e em regência coral no ensino de pessoas com deficiência`,
        info_title: `Edino Krieger`,
        info_text: `Compositor brasileiro e um dos criadores das bienais de música contemporânea e da Orquestra Sinfônica Nacional.`,
        videos: [
          {
  ...
  oficinasderegencia: {
    ...
    categories: [
      {
        id: 'danielly-souza',
        cover: '/img/static/or-danielly-souza.jpg',
        title: 'Gestual da Regência',
        text: `Esta oficina vai detalhar as diferentes maneiras de marcação para as fórmulas de compassos básicas, abordando os padrões gestuais unário, binário, ternário e quaternário e sua aplicabilidade em diferentes escolas de regência.`,
        info_title: `Danielly Souza`,
        info_text: `Mestre em Música pela Universidade Federal do Rio de Janeiro.`,
        videos: [
          {
            id: 'aula-01',
            title: 'Aula 1',
